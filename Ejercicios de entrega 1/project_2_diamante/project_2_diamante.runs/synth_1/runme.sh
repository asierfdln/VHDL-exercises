...
HD_PWD='C:/Users/iratxe.campo/project_2_diamante/project_2_diamante.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_2_diamante.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_2_diamante.tcl
