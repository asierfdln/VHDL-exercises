...
HD_PWD='C:/Users/iratxe.campo/project_3_notas/project_3_notas.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_3_notas.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_3_notas.tcl
