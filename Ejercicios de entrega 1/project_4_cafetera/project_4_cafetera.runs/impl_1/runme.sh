...
HD_PWD='C:/Users/iratxe.campo/project_4_cafetera/project_4_cafetera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_4_cafetera.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_4_cafetera.tcl -notrace
