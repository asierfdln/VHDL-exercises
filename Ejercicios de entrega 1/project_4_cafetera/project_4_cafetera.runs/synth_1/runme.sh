...
HD_PWD='C:/Users/iratxe.campo/project_4_cafetera/project_4_cafetera.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_4_cafetera.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_4_cafetera.tcl
