...
HD_PWD='C:/Users/asierfdln/project_9/project_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_9.tcl -notrace
