...
HD_PWD='C:/Users/asierfdln/project_9/project_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_9.tcl
