...
HD_PWD='C:/Users/iratxe.campo/project_2_diamante/project_2_diamante.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_2_diamante.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_2_diamante.tcl -notrace
