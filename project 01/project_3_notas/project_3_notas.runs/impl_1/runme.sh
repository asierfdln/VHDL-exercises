...
HD_PWD='C:/Users/iratxe.campo/project_3_notas/project_3_notas.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_3_notas.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_3_notas.tcl -notrace
