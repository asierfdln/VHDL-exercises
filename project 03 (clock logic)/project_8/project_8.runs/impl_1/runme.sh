...
HD_PWD='C:/Users/iratxe.campo/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_8.tcl -notrace
