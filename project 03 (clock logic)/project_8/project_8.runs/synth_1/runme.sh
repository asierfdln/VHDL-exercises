...
HD_PWD='C:/Users/iratxe.campo/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_8.tcl
