...
HD_PWD='C:/Users/iratxe.campo/project_10_pwm/project_10_pwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_10_pwm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_10_pwm.tcl -notrace
