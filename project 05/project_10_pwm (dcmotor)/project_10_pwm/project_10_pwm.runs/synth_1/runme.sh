...
HD_PWD='C:/Users/iratxe.campo/project_10_pwm/project_10_pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_10_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_10_pwm.tcl
